...
class DeliveranceMailChimpList extends DeliveranceList
{
     ...
     * @var int
     */
    public const POLLING_INTERVAL = 10;
    ...
    protected $list_merge_array_map = [];
     ...
     *
     * @return bool whether or not the service is available
     */
    ...
    public function subscribe($address, array $info = [])
    {
        $result = false;
        $queue_request = false;
    ...
    public function update($address, array $info = [])
    {
        $result = false;
        $queue_request = false;
